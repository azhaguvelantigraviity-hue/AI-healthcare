...
const { doctorRouter, patientRouter, adminRouter, reportRouter, prescriptionRouter, aiRouter, notificationRouter, consultationRouter, symptomRouter, paymentRouter, insuranceRouter } = require('./routes/index');
