...
const seedData = async () => {
  ...
  console.log('🩺 Doctor:  sarah@healthsys.com    | Doctor@123');
  console.log('🩺 Doctor:  michael@healthsys.com  | Doctor@123');
  console.log('🧑 Patient: james@email.com        | Patient@123');
  console.log('🧑 Patient: emma@email.com         | Patient@123');
  console.log('='.repeat(50));
