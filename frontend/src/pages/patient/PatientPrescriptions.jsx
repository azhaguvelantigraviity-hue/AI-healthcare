...
const PatientPrescriptions = () => {
  ...
  const [medications, setMedications] = useState([
    { id: 1, name: 'Lisinopril', dosage: '10mg', timing: '08:00 AM', status: 'pending', doctor: 'Dr. Sarah Jenkins' },
    { id: 2, name: 'Atorvastatin', dosage: '20mg', timing: '08:00 PM', status: 'pending', doctor: 'Dr. Sarah Jenkins' },
    { id: 3, name: 'Metformin', dosage: '500mg', timing: '12:00 PM', status: 'missed', doctor: 'Dr. Michael Chen' },
    { id: 4, name: 'Aspirin', dosage: '81mg', timing: '08:00 AM', status: 'taken', doctor: 'Dr. Sarah Jenkins' },
  ]);
  ...
  const mockPrescriptions = [
    {
      ...
      date: '2026-06-18',
      medicines: [
        { name: 'Lisinopril', dosage: '10mg', timing: 'Once daily (Morning)', duration: '30 days', refills: 2 },
        { name: 'Atorvastatin', dosage: '20mg', timing: 'Once daily (Night)', duration: '30 days', refills: 1 }
      ],
      status: 'Active'
    },
    {
      ...
      date: '2026-05-10',
      medicines: [
        { name: 'Metformin', dosage: '500mg', timing: 'Twice daily', duration: '90 days', refills: 0 }
      ],
      status: 'Active'
    }
  ];
